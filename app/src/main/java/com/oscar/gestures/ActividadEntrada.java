...
public class ActividadEntrada extends AppCompatActivity implements FragmentoNuevoGesto.OnFragmentInteractionListener {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public static Fragment newInstance(int sectionNumber) {
            ...
            */
            ...
            LogCat.info(ConstantsGestures.TAG," SECTION NUMBER: " + sectionNumber);

            FragmentoNuevoGesto fragmento = new FragmentoNuevoGesto();
            return fragmento;
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
            View rootView = inflater.inflate(R.layout.fragment_actividad_entrada, container, false);
